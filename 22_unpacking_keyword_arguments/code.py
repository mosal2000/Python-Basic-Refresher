...
named(name="Zaid", age=25)
# named({"name": "Zaid", "age": 25})  # Error, the dictionary is actually a positional argument.
...
myfunction(**"Zaid")  # Error, must be mapping
