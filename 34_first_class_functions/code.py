...
print(search(friends, "Zaid Smith", get_friend_name))
...
print(search(friends, "Zaid Smith", lambda friend: friend["name"]))
...
print(search(friends, "Dija Smith", itemgetter("name")))
